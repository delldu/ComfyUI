...
class LoadImage:
    ...
    def load_image(self, image):
        ...
        # tensor [image] size: [1, 600, 458, 3], min: 0.0, max: 1.0, mean: 0.464868, vae_encode_input

        # tensor [image] size: [600, 458], min: 0.0, max: 0.0, mean: 0.0
