...
def test_refiner():
    ...
    #     
    # tensor [positive_tensor] size: [1, 77, 1280], min: -66.179367, max: 18.368395, mean: 0.035082
    # tensor [positive_pooled] size: [1, 1280], min: -3.958433, max: 3.203121, mean: 0.009559
    # Standard
    ...
    # tensor [negative_tensor] size: [1, 77, 1280], min: -66.179367, max: 18.368395, mean: 0.029526
    # tensor [negative_pooled] size: [1, 1280], min: -3.58707, max: 3.409506, mean: 0.024002
    # Standard 
